                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto" style="display: flex;justify-content: space-around;flex-wrap: nowrap;width: 100%;">
                        @if (Auth::check() and Auth::user()->role === 'admin')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('home.users') }}">{{ __('Utilisateurs') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('home.admin.hotel') }}">{{ __('Hotel') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('home.admin.voyage') }}">{{ __('Voyage') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('home.voyage.commande') }}">{{ __('Les commandes') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('home.demande-hotel') }}">{{ __('Demande') }}</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('home.voyage.create') }}">{{ __('Ajoute voyage') }}</a>
                            </li>
                        @endif
                    </ul>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-center" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('home.profile.admin') }}">{{ __('Profile') }}</a>
                                    <a class="dropdown-item" href="{{ route('home.notifications-admin') }}">{{ __('Notifications') }}</a>
