...
<div class="container" style="margin-top: 50px;">
    <form class="input-barresea" method="POST" action="{{ route('home.hotel.chambre.gestion.search',$hotel->id) }}" >
        @csrf
        @method('POST')
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-center">
                                        <a class="btn btn-secondary col-8" href="{{ route('home.hotel.edit',$hotel->id) }}" role="button">Modifier</a>
                                    </div>
                                    {{-- <div class="col-md-6 text-end">
    ...
    <div class="col-md-12 text-center">
        <form style="box-shadow: none" method="get" action="{{ route('home.hotel.chambre.create') }}">
            @csrf
            <input type="hidden" name="hotel_id" value="{{ $hotel->id }}">
            <button class="btn btn-success" style="margin-top: 20px" href="#" type="submit">Ajoute de chambres</button>
        </form>
    </div>
    <hr>
            ...
            @foreach ($chambres as $chambre)
                <div class="card mb-4 shadow mb-4 bg-white" style="max-width: 620px;">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <a class="btn btn-secondary" href="{{ route('home.hotel.chambre.edit',$chambre->id) }}" role="button">Modifier</a>
                            </div>
                            <div class="col-sm-6 text-end">
