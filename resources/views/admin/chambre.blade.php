...
<div class="container" style="margin-top: 50px;">
    <form class="input-barresea" method="POST" action="{{ route('home.admin.hotel.chambre.search',$hotel->id) }}" >
        @csrf
        @method('POST')
                            ...
                            <div class="col-sm-6 text-end">
                                @if ($chambre->status == 'disponible' or $chambre->status == 'Disponible' )
                                    <div class="col-sm-12 text-center">
                                        <button class="btn btn-danger col-12"  data-bs-toggle="modal" data-bs-target="#confirm-delete-modal-{{ $chambre->id }}">Supprimer</button>
                                    </div>
                                @else
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <form style="box-shadow: none" method="POST" action="{{ route('home.admin.hotel.chambre.destroy',$chambre->id) }}">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-danger col-8">Supprimer</button>
                                </form>
                            </div>
                        </div>
                    </div>
